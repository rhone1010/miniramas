...
# -*- coding: utf-8 -*-
"""
patch-signin-invite-r2.py  -  CUI 41A  -  25 August 2026
...
r2: the same five edits as r1 (live on portraits since this
morning), replicated to the five remaining rooms. Anchors are exact;
any room whose card has drifted refuses by name and gets a re-cut.
...
FILES = ["pets.html", "groups.html", "halloween.html",
         "pets-halloween.html", "pets-chooser.html"]
