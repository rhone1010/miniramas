...
# -*- coding: utf-8 -*-
"""
patch-floor-safari-r2.py  -  CUI 41A  -  26 August 2026
...
r2: the same two edits for the three wallpaper rooms, which were
cloned from the workshop shape before the cure existed (the hunt
table: FitFloor 1, Sized 0). Cross-lane by Rich's ruling A - 42 gets
the note after it ships. If edit B refuses (their silo paint may
differ from the workshop's), re-cut from a Select-String.
"""
import os, sys, io

FILES = ["wallpapers-portraits.html", "wallpapers-pets.html",
