...
Background: Endless dead cornfields surround an ancient stone altar, with burning pumpkins, crooked scarecrows and distant farmhouses disappearing into harvest fog. The upper third darkens around an enormous blood-red harvest moon, black trees and gathering storm clouds.`,
  ...
  werewolf: {
    id:    'werewolf',
    label: 'Werewolf',
    body: `Transform the subject into a magnificent human-werewolf hybrid while preserving recognizable facial structure and expression. Powerful but elegant, textured silver-brown fur emerging naturally across the face and body, luminous amber eyes, subtle fangs, torn dark clothing. Cinematic moonlight, adventurous supernatural fantasy, change jaw slightly and have the subject howling. 
...
Background: A ruined alien landscape stretches beneath a black sky as mountains and ancient monoliths dissolve upward into stars and cosmic dust. The enormous eclipsed sun dominates the dim upper third, its fiery corona fading through black clouds and drifting celestial debris.`,
  ...
  ghoul: {
    id:    'ghoul',
    label: 'Ghoul',
    body: `Transform the subject into an elegant ghoul while retaining their recognizable identity. Beautiful aged ivory bone, dark formal clothing, subtle supernatural glow within the eyes. Highly detailed cinematic fantasy, mysterious and playful rather than macabre or frightening. keep 60% likeness
...
Background: The figure rises from the center of an immense ruined medieval city as streets and buildings appear to merge physically into its cathedral body. The upper third becomes a dark storm-filled sky where towering spires, gargoyles and a pale moon disappear into clouds and mist.`,
  ...
  gothic_witch: {
    id:    'gothic_witch',
    label: 'Gothic Witch',
    body: `Transform the subject into an epic gothic witch, likeness unmistakable. Beautiful but terrifying, deathly pale skin, blackened eyes, wind-whipped hair, towering distressed hat, shredded black velvet, occult jewelry, claw-like fingers, supernatural smoke and violet energy. Photoreal cinematic dark fantasy, extreme detail, sinister, powerful, genuinely frightening.
