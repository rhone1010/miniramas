...
export const HOUSES_EFFECT_CATALOG: Record<string, CatalogEntry> = {
  ...
  scaled_architectural: { collection: 'materials', label: 'Museum',           detail_dependency: 'high',   description: 'A museum-grade architectural model, crisp and exact.' },
  snow_globe:           { collection: 'materials', label: 'Snow Globe',       detail_dependency: 'low',    description: 'Your home inside a glass snow globe, lit warmly from within.' },
  ...
  gingerbread:          { collection: 'materials', label: 'Gingerbread',      detail_dependency: 'low',    description: 'A gingerbread house, iced, trimmed, and entirely charming.' },
  watercolor_wood:      { collection: 'materials', label: 'Painted Wood',     detail_dependency: 'low',    description: 'A painted wooden model with hand-brushed charm.' },
  dollhouse:            { collection: 'materials', label: 'Dollhouse',        detail_dependency: 'medium', description: 'An open-back dollhouse with furnished, lit rooms.' },
  // ── Seasons ──
  ...
  watercolor_study:     { collection: 'artists',   label: 'Watercolor Study', detail_dependency: 'medium', description: 'A dimensional watercolor rising from the painted sheet.' },
...
- At least 1 from the artists collection and at least 1 from the materials collection
