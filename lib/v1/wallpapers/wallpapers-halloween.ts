...
// row on The Ferryman. "NO phone elements. No UI elements" is the wording
// that holds.
//
// ── OPEN, FOR RICH ─────────────────────────────────────────────────────
//
...
export const HALLOWEEN_WALLPAPERS: Record<string, WallpaperEffect> = {
  ...
  lantern_keeper: {
    ...
    silo:  'halloween',
    body: `Keep subject in lower 2/3 of image to allow for phone UI elements. This is a mobile wallpaper. 
...
Background: A distant Gothic castle rises through rolling midnight fog beneath a huge pale moon. Keep the upper third atmospheric and progressively darker so phone interface elements remain clearly visible.`,
  },
...
Keep subject in lower 2/3 of image to allow for phone UI elements. This is a mobile wallpaper. 
...
Background: An old cemetery stretches into blue-black fog with crooked monuments, bare trees and tiny distant lanterns. Moonlight creates depth below while the upper third gradually falls into a dark, quiet night sky. keep subject in lower three quarters of the image too allow for phone screen clock.`,
  },
...
Background: A colossal ruined gothic castle rises through storm clouds, ravens circling its broken towers as lightning illuminates distant mountains. The upper third descends into near-black storm, moonlight and atmospheric haze for phone UI.`,
  },
...
Background: A burning jack-o'-lantern-lined road tears through a dead forest toward a ruined gothic village beneath a blood-orange moon. Twisted branches and smoke climb into a dramatically darker upper third, leaving subdued detail behind phone UI.`,
...
Background: A vast dead cornfield burns faintly beneath an enormous harvest moon, with crooked scarecrows disappearing into rolling ground fog and a decaying farmhouse beyond. The upper third becomes darker and stormier, with silhouettes and muted moonlight allowing room for phone clock as a wallpaper`,
...
do not include phone elements.`,
  ...
  demon_lord: {
    ...
    label: 'Demon Lord',
    silo:  'halloween',
    body: `Transform the subject into an epic Demon Lord while preserving exact facial identity and proportions. Human features remain unmistakable beneath obsidian skin fissures glowing with internal fire, sweeping horns, blackened crown, infernal armor and enormous shadowed wings. Photoreal cinematic dark fantasy horror, terrifying, regal, monumental. Keep subject in lower 2/3 of image to allow for phone UI elements. This is a mobile wallpaper.
Background: A vast infernal fortress rises from volcanic cliffs surrounded by fire, smoke and drifting embers. The upper third fades into a nearly black crimson sky with distant peaks and an enormous eclipsed moon. NO phone elements. No UI elements`,
  },
