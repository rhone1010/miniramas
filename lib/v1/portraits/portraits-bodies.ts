...
Frame mid-chest to top of head, face prominent, camera at eye level, eyes toward viewer, natural warm smile. Both shoulders fully rendered. Sculpture stands on a simple base. Fine charcoal dust, chalk powder and a few fragments hang subtly in the air.
Set in a **beautiful old-world artist's atelier**, heavily blurred: aged timber, plaster walls, antique easels, stacked canvases, pinned charcoal studies and drawing tools beneath a huge ribbed iron-and-glass skylight. Soft directional daylight reveals charcoal texture, chalk buildup and airborne dust. Atmospheric, romantic, shallow depth of field.
Clear temporary blemishes and blotchiness, but **do not reshape, de-age, enlarge eyes, correct asymmetry or alter permanent facial structure.** No held objects, eyewear, watches, plaques or legible text. Worn jewellery is fine.`,
  ...
  chocolate: {
    id:    'chocolate',
    body:  `convert the subject into a rich chocolate sculpture. smooth brown milk chocolate with highly detailed features. do not crop subject. head and shoulders should be visible. satin sheen on entire sculpture Framed from mid-chest to the top of the head, both shoulders and upper arms fully rendered. The subject's own garment carries through in the same material. Flattering soft key light, shadow separating jaw from neck. Clear the skin - blemishes, spots and blotchiness go. Keep permanent structure: lines, scars and the natural asymmetry of the face. Add nothing that is not in the source. Never reshape, enlarge eyes, correct asymmetry or de-age. No held objects - no cups, glasses, phones, books, tools, watches or eyewear. Worn jewellery is fine: necklaces, earrings, piercings.
...
No letters or held objects.`,
  ...
  polished_gold: {
    id:    'polished_gold',
    body:  `Transform the entire figure into a contemporary polished gold sculpture — mirror-bright warm yellow gold with a high specular finish, the surface smooth and flowing with no visible tool marks. hair is poured liguid gold that matches the subjects with deep carved separations catching bright highlights. No human skin anywhere — the face is polished gold like the rest. Framed from mid-chest to the top of the head, both shoulders and upper arms fully rendered. The subject's own garment carries through in the same material.  Flattering soft key light, shadow separating jaw from neck. framed from stomach to top of head. the background is an expensively appointed conservatory with many windows with warm lighting streaming through inside potted trees and plants. Make the creation match age.
...
**Avoid:** segmented or patchwork faces, puffy cheeks, rounded generic features, altered facial structure, real skin or hair, painted-on features, children's colors, or sacrificing likeness for balloon-animal construction.`,
...
He belongs completely to the period rather than appearing as a modern person in historical costume. Give him a natural, reserved courtly posture, shoulders slightly turned, head turned approximately 30 degrees to the left and eyes looking quietly to the side. His presence is noble, composed and self-possessed. Avoid modern portrait poses and contemporary fashion or glamour styling. his arm is resting on a period wooden pedestal. the subject is looking up slightly
