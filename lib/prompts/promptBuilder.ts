...
MATERIALS:
Use ${material} materials with fine surface variation, subtle edge highlights, and crisp material transitions.
All elements must share a consistent material language.
Every surface reads as a premium physical miniature material — no photographic textures, no flat planes.
Render as premium product photography of a real handcrafted collectible object.
...
Avoid flat or overexposed surfaces — every face of the miniature must show depth and material response.
...
- Premium product photography of a real physical collectible object on a wooden surface
